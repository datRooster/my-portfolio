...
export default function ProjectsManagement() {
  ...
  const addTag = (type: 'categories' | 'technologies', tag: string) => {
  ...
  const removeTag = (type: 'categories' | 'technologies', index: number) => {
    setNewProject(prev => ({  
      ...prev,
    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-400">Gestisci i tuoi progetti del portfolio</p>
        </div>
        <button
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            <input
              ...
              className="w-full bg-gray-900 border border-gray-600 rounded-lg px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:border-yellow-500"
            />
          </div>
          <div>
            <select
                ...
                {project.technologies.length > 0 && (
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, index) => (
                      <span key={index} className="bg-green-500 bg-opacity-20 text-green-400 px-2 py-1 rounded text-xs">
                        {tech}
                      </span>
                    ))}
                  </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-gray-800 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={editingProject ? handleUpdateProject : handleCreateProject} className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-white mb-2">Priorità</label>
                  <input
                    type="number"
                    min="1"
                    max="10"
